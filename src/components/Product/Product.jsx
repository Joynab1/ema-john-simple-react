    ...
    return (
        <>
            <div className="card w-full bg-base-100 shadow-2xl my-5">
                <figure className='lg:h-[286px] lg:w-[286px]'><img src={img} alt="" /></figure>
                ...
                <div className="card-actions w-full justify-center mt-4">
                    <button className="btn bg-accent w-full" onClick={() => handleAddToCart(props.product)}>Add to Cart <span className='ml-4'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
